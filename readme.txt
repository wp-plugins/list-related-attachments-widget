...
Tags: widget, list, related, attachments, sidebar, uploaded, files
...
4. Configure the `Listed Related Attachments` widget options.
5. Test that the this plugin meets your demanding needs.
6. Rate the plugin at wordpress.org.
7. Leave a comment regarding bugs, feature request, cocktail recipes at www.twinpictures.de
